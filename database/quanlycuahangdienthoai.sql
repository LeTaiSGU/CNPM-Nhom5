...
('KM2', 'Giảm giá nhân ngày 20/11', 5000000, 30, '2023-11-20', '2023-12-20'),
('KM3', 'Giảm giá kỷ niệm khai trương', 2000000, 10, '2023-04-30', '2023-05-01'),
('KM4', 'Giảm giá tết', 15000000, 20, '2023-09-19', '2023-09-20'),
('KM5', 'Khuyến mãi xả hàng', 1000000, 50, '2023-09-18', '2023-09-25'),
('KM6', 'Khuyến mãi mùa hè', 15000000, 20, '2023-07-18', '2023-09-27'),
('KM7', 'Khuyến mãi mùa hè 2', 5000000, 5, '2023-08-22', '2023-10-24');
...
-- Thêm ràng buộc CHECK vào bảng nhacungcap
ALTER TABLE nhacungcap
ADD CONSTRAINT chk_SDT_NV_Length CHECK (LENGTH(SDT) = 10);
